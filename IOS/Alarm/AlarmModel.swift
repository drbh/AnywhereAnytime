...
struct Alarm: PropertyReflectable {
    var date: Date = Date()
    var ogDate: Date = Date()
    var enabled: Bool = false
    var snoozeEnabled: Bool = false
    var repeatWeekdays: [Int] = []
    var uuid: String = ""
    var mediaID: String = ""
    var tzStr: String = "GMT"
    ...
    init(date:Date, enabled:Bool, snoozeEnabled:Bool, repeatWeekdays:[Int], uuid:String, mediaID:String, tzStr:String, mediaLabel:String, label:String, onSnooze: Bool){
        self.date = date
        self.ogDate = date
...
extension Alarm {
    var formattedTimeOri: String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "h:mm a"
        return dateFormatter.string(from: self.ogDate)
    }
}
